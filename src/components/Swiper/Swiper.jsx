...
export default function CustomSwiper({ data }) {
  ...
  function handleCLickPlay(){
    user ? navigate(`/movie/${item.id}`) : toast("Please Log in to play this movie");
  }
            ...
            <div className="slider-container p-5">
              <div className='w-[1280px] mt-[174px] mx-auto flex items-start justify-between'>
                <div>
                  ...
                  <Button onClick={handleCLickToSingle} variant='contained' size='large' className='!text-white !bg-[#9747FF]'>watch</Button>
                </div>
                <div className='relative'>
                  ...
                  <button onClick={handleCLickPlay} className='absolute  text-white scale-[2]  inset-0 m-auto'><PlayCircle /></button>
                </div>
              </div>
            </div>
          </SwiperSlide>
